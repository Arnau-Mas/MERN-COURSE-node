          ...
          <Link to={`/articulo/${articulo.id}`}>
            ...
            <div className="flex item-center justify-between mt-3">
              <div className="flex flex-row w-56 rounded-lg relative bg-transparent mt-1">
                <button onClick={() => setCantidad(prev => prev-1)} data-action="decrement" className=" bg-gray-300 text-gray-600 hover:text-gray-700 hover:bg-gray-400 h-full w-8 rounded-l cursor-pointer outline-none">
              ...
              <button onClick={() => setCantidad(prev => prev+1)} data-action="increment" className="bg-gray-300 text-gray-600 hover:text-gray-700 hover:bg-gray-400 h-full w-8 rounded-r cursor-pointer">
                <span className="m-auto text-2xl font-thin">+</span>
              </button>
            </div>
