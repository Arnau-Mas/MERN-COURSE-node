...
export const Sidebar = () => {
  return (
    ...
    <ul className=" px-1">
      <li className="">
        <Link to="/nuevoArticulo" className="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-green-700 text-ellipsis whitespace-nowrap rounded hover:text-green-600 hover:bg-blue-50 transition duration-300 ease-in-out" href="#!" data-mdb-ripple="true" data-mdb-ripple-color="primary">
      ...
      <li className="" id="sidenavXxEx2">
        ...
        <ul className="accordion-collapse collapse" id="collapseSidenavXxEx2" aria-labelledby="sidenavXxEx2" data-bs-parent="#sidenavSecExample">
          <li className="">
