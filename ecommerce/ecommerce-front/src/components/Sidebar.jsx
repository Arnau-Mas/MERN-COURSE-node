...
export const Sidebar = () => {
  return (
    <div class="w-96 h-screen static shadow-md bg-white" id="sidenavSecExample">
    <ul class=" px-1">
      <li class="">
        <h4 class="flex mt-4 items-center text-xl justify-center align-middle  h-12 overflow-hidden text-ellipsis whitespace-nowrap rounded transition duration-300 ease-in-out"data-mdb-ripple="true" data-mdb-ripple-color="primary">
        Tendencias
        </h4>
      </li>
    </ul>
    ...
    <ul class=" px-1">
      ...
      <li class="" id="sidenavXxEx2">
        ...
        <ul class="accordion-collapse collapse" id="collapseSidenavXxEx2" aria-labelledby="sidenavXxEx2" data-bs-parent="#sidenavSecExample">
          <li class="">
